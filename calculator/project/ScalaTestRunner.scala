...
object ScalaTestRunner {
  ...
  private def computeSummary(outFilePath: String,
                             classpathString: String,
                             logError: String => Unit): String = {
  ...
  private def unpickleSummary(logError: (String) => Unit,
                              runLog: String,
                              summaryFileStr: String): GradingSummary = {
    try {
      scala.io.Source
